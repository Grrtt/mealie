...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../app/plugins/app-info.client")> &
  InjectionType<typeof import("../../app/plugins/axios")> &
  InjectionType<typeof import("../../app/plugins/dark-mode.client")> &
  InjectionType<typeof import("../../app/plugins/globals")> &
  InjectionType<typeof import("../../app/plugins/init-auth.client")> &
  InjectionType<typeof import("../../app/plugins/theme")> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'vuetify:i18n:plugin' | 'vuetify:icons:plugin' | 'nuxt:head' | 'nuxt:router' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'i18n:plugin:switch-locale-path-ssr' | 'i18n:plugin:route-locale-detect' | 'i18n:plugin' | 'nuxt:global-components' | 'nuxt:prefetch' | 'vite-pwa:nuxt:pwa-icons-plugin' | 'i18n:plugin:ssg-detect' | 'vite-pwa:nuxt:client:plugin' | 'vuetify:nuxt:server:plugin' | 'vuetify:nuxt:client:plugin'
  }
}
