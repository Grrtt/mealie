...
import { a as joinRelativeURL, u as useRuntimeConfig, g as getResponseStatusText, b as getResponseStatus, c as defineRenderHandler, e as getQuery, f as createError, h as destr, i as getRouteRules, j as joinURL, k as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"property":"og:type","content":"website"},{"property":"og:title","content":"Mealie"},{"property":"og:site_name","content":"Mealie"},{"property":"og:description","content":"Mealie is a recipe management app for your kitchen."},{"property":"og:image","content":"https://raw.githubusercontent.com/mealie-recipes/mealie/9571816ac4eed5beacfc0abf6c03eff1427fd0eb/frontend/static/icons/android-chrome-512x512.png"},{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Mealie is a recipe management app for your kitchen."}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"shortcut icon","type":"image/png","href":"/icons/icon-x64.png"},{"rel":"apple-touch-icon","type":"image/png","href":"/icons/apple-touch-icon.png"},{"rel":"mask-icon","href":"/icons/safari-pinned-tab.svg"},{"rel":"manifest","href":"/manifest.webmanifest","crossorigin":"use-credentials"}],"style":[],"script":[{"innerHTML":"(function(){try{var d=localStorage.getItem('vueuse-color-scheme');var m=d==='dark'||(d!=='light'&&matchMedia('(prefers-color-scheme:dark)').matches);document.documentElement.style.backgroundColor=m?'#1E1E1E':'#FFFFFF'}catch(e){}})()","type":"text/javascript"}],"noscript":[],"title":"Mealie"};
