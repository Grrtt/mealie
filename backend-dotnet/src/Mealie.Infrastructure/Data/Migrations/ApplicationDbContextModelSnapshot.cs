...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mealie.Domain.Entities.Settings.RecipeAction", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_recipe_actions");

                    b.HasIndex("GroupId")
                        .HasDatabaseName("ix_recipe_actions_group_id");

                    b.HasIndex("HouseholdId")
                        .HasDatabaseName("ix_recipe_actions_household_id");

                    b.ToTable("recipe_actions", (string)null);
                });
            ...
            modelBuilder.Entity("Mealie.Domain.Entities.Settings.RecipeAction", b =>
                {
                    ...
                    b.HasOne("Mealie.Domain.Entities.Core.Household", "Household")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_recipe_actions_households_household_id");
