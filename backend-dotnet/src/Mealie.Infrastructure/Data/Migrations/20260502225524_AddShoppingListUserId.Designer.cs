...
namespace Mealie.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260502225524_AddShoppingListUserId")]
    partial class AddShoppingListUserId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mealie.Domain.Entities.Ingredients.IngredientUnitAlias", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_ingredient_units_aliases");

                    b.HasIndex("UnitId")
                        .HasDatabaseName("ix_ingredient_units_aliases_unit_id");

                    b.ToTable("ingredient_units_aliases", (string)null);
                });
            ...
            modelBuilder.Entity("Mealie.Domain.Entities.Planning.MealPlanRule", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_group_meal_plan_rules");

                    b.HasIndex("GroupId")
                        .HasDatabaseName("ix_group_meal_plan_rules_group_id");

                    b.HasIndex("HouseholdId")
                        .HasDatabaseName("ix_group_meal_plan_rules_household_id");

                    b.ToTable("group_meal_plan_rules", (string)null);
                });
            ...
            modelBuilder.Entity("Mealie.Domain.Entities.Planning.ShoppingList", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_shopping_lists_user_id");
            ...
            modelBuilder.Entity("Mealie.Domain.Entities.Settings.AiConfiguration", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                    ...
                    b.Property<bool>("EnableImageServices")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(true)
                        .HasColumnName("enable_image_services");

                    b.Property<bool>("EnableTranscriptionServices")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(true)
                    ...
                    b.HasIndex("IsActive")
                        .HasDatabaseName("ix_ai_configurations_is_active");
            ...
            modelBuilder.Entity("Mealie.Domain.Entities.Settings.SiteSettings", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("plan_rules_to_categories", b =>
                {
                    ...
                    b.HasKey("group_plan_rule_id", "category_id")
                        .HasName("pk_plan_rules_to_categories");

                    b.HasIndex("category_id")
                        .HasDatabaseName("ix_plan_rules_to_categories_category_id");

                    b.ToTable("plan_rules_to_categories", (string)null);
                });
            ...
            modelBuilder.Entity("plan_rules_to_households", b =>
                {
                    ...
                    b.HasKey("group_plan_rule_id", "household_id")
                        .HasName("pk_plan_rules_to_households");

                    b.HasIndex("household_id")
                        .HasDatabaseName("ix_plan_rules_to_households_household_id");

                    b.ToTable("plan_rules_to_households", (string)null);
                });
            ...
            modelBuilder.Entity("plan_rules_to_tags", b =>
                {
                    ...
                    b.HasKey("plan_rule_id", "tag_id")
                        .HasName("pk_plan_rules_to_tags");

                    b.HasIndex("tag_id")
                        .HasDatabaseName("ix_plan_rules_to_tags_tag_id");
            ...
            modelBuilder.Entity("Mealie.Domain.Entities.Planning.ShoppingList", b =>
                {
                    ...
                    b.HasOne("Mealie.Domain.Entities.Core.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_shopping_lists_users_user_id");
            ...
            modelBuilder.Entity("plan_rules_to_categories", b =>
                {
                    b.HasOne("Mealie.Domain.Entities.Organizers.Category", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_plan_rules_to_categories_categories_category_id");
            ...
            modelBuilder.Entity("plan_rules_to_households", b =>
                {
                    ...
                    b.HasOne("Mealie.Domain.Entities.Core.Household", null)
                        .WithMany()
                        .HasForeignKey("household_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_plan_rules_to_households_households_household_id");
                });
