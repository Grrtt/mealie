    ...
    public partial class FixAiConfigurationColumns : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            if (migrationBuilder.ActiveProvider.Contains("Npgsql"))
            {
                migrationBuilder.Sql("""
                    ...
                    ADD COLUMN IF NOT EXISTS enable_image_services integer NOT NULL DEFAULT 1;
                    """);

                migrationBuilder.Sql("""
                    ALTER TABLE ai_configurations
                    ADD COLUMN IF NOT EXISTS enable_transcription_services integer NOT NULL DEFAULT 1;
                    """);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            if (migrationBuilder.ActiveProvider.Contains("Npgsql"))
            {
                migrationBuilder.Sql("""
                    ALTER TABLE ai_configurations
                    DROP COLUMN IF EXISTS enable_image_services;
                    """);

                migrationBuilder.Sql("""
                    ALTER TABLE ai_configurations
                    DROP COLUMN IF EXISTS enable_transcription_services;
                    """);
            }
            else
            {
