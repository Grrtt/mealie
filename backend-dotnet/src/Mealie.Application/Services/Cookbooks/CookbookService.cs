...
{
    public async Task<PaginatedResponse<CookbookResponse>> GetCookbooksAsync(Guid householdId,
    ...
    {
        var c = await db.Cookbooks.IgnoreQueryFilters()
    ...
    public async Task<CookbookResponse> CreateAsync(Guid groupId, Guid householdId, CreateCookbookRequest request,
    ...
    public async Task<CookbookResponse?> UpdateAsync(Guid householdId, Guid id, UpdateCookbookRequest request,
        CancellationToken ct = default)
    {
    ...
    public async Task<bool> ReorderAsync(Guid householdId, IEnumerable<CookbookReorderRequest> reorderRequests,
        CancellationToken ct = default)
    {
    ...
    private static CookbookResponse MapToResponse(Cookbook c)
    {
