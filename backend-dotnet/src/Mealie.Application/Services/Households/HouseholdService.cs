...
public class HouseholdService(ApplicationDbContext db, ILogger<HouseholdService> logger) : IHouseholdService
{
    ...
    public async Task<HouseholdResponse?> UpdateHouseholdAsync(Guid householdId, UpdateHouseholdRequest request,
    ...
    public async Task<HouseholdResponse> CreateHouseholdAsync(Guid groupId, CreateHouseholdRequest request,
        CancellationToken ct = default)
    {
    ...
    public async Task<HouseholdPreferencesResponse?> GetHouseholdPreferencesAsync(Guid householdId,
        CancellationToken ct = default)
    {
    ...
    public async Task<HouseholdPreferencesResponse?> UpdateHouseholdPreferencesAsync(Guid householdId,
        UpdateHouseholdPreferencesRequest request, CancellationToken ct = default)
    {
        var prefs = await db.HouseholdPreferences.IgnoreQueryFilters()
            .FirstOrDefaultAsync(p => p.HouseholdId == householdId, ct);
        if (prefs is null)
    ...
    public async Task<InviteTokenResponse> CreateHouseholdInviteTokenAsync(Guid groupId, Guid householdId,
        CreateInviteTokenRequest request, CancellationToken ct = default)
    {
    ...
    public async Task<bool> UpdateMemberPermissionsAsync(Guid householdId, Guid userId, bool admin, bool canOrganize,
        bool canInvite, CancellationToken ct = default)
    {
    ...
    private static HouseholdResponse MapToResponse(Household h)
    {
    ...
    private static HouseholdPreferencesResponse MapToHouseholdPreferencesResponse(HouseholdPreferences prefs)
    {
