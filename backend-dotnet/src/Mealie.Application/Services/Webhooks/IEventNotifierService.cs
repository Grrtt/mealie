...
public interface IEventNotifierService
{
    ...
    Task<EventNotifierResponse> CreateAsync(Guid groupId, Guid householdId, CreateEventNotifierRequest request,
        CancellationToken ct = default);

    Task<EventNotifierResponse?> UpdateAsync(Guid householdId, Guid id, CreateEventNotifierRequest request,
        CancellationToken ct = default);
