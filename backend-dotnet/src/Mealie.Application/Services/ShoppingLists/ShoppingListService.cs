...
{
    public async Task<PaginatedResponse<ShoppingListSummaryResponse>> GetShoppingListsAsync(Guid householdId,
    ...
    public async Task<ShoppingListResponse> CreateAsync(Guid groupId, Guid householdId,
        CreateShoppingListRequest request, CancellationToken ct = default)
    {
    ...
    public async Task<ShoppingListResponse?> UpdateAsync(Guid householdId, Guid id, UpdateShoppingListRequest request,
    ...
    public async Task<ShoppingListItemResponse> AddItemAsync(Guid householdId, Guid listId,
        CreateShoppingListItemRequest request, CancellationToken ct = default)
    {
    ...
    public async Task<ShoppingListItemResponse?> UpdateItemAsync(Guid householdId, Guid listId, Guid itemId,
    ...
    public async Task<PaginatedResponse<ShoppingListItemResponse>> GetItemsAsync(Guid householdId,
        PaginationParams pagination, bool? checked_ = null, CancellationToken ct = default)
    {
    ...
    public async Task<ShoppingListItemResponse?> GetItemByIdAsync(Guid householdId, Guid itemId,
        CancellationToken ct = default)
    {
        var item = await db.ShoppingListItems
            .Include(i => i.Unit)
    ...
    public async Task<ShoppingListItemResponse> CreateStandaloneItemAsync(Guid householdId,
        CreateShoppingListItemRequest request, Guid listId, CancellationToken ct = default)
    {
        _ = await db.ShoppingLists.IgnoreQueryFilters()
                .FirstOrDefaultAsync(s => s.HouseholdId == householdId && s.Id == listId, ct)
            ?? throw new KeyNotFoundException("Shopping list not found");
    ...
    public async Task<IList<ShoppingListItemResponse>> CreateBulkItemsAsync(Guid householdId,
    ...
    public async Task<IList<ShoppingListItemResponse>> UpdateBulkItemsAsync(Guid householdId,
    ...
    public async Task<bool> DeleteBulkItemsAsync(Guid householdId, BulkDeleteShoppingListItemRequest request,
        CancellationToken ct = default)
    {
        var items = await db.ShoppingListItems
            .Include(i => i.ShoppingList)
    ...
    public async Task<ShoppingListResponse?> AddRecipeAsync(Guid householdId, Guid listId,
        AddRecipeToShoppingListRequest request, CancellationToken ct = default)
    {
        var list = await db.ShoppingLists.IgnoreQueryFilters()
    ...
    public async Task<bool> RemoveRecipeAsync(Guid householdId, Guid listId, Guid recipeId,
        CancellationToken ct = default)
    {
        var list = await db.ShoppingLists.IgnoreQueryFilters()
            .FirstOrDefaultAsync(s => s.HouseholdId == householdId && s.Id == listId, ct);
    ...
    private static ShoppingListItemResponse MapItemToResponse(ShoppingListItem i)
    {
