...
public interface IAdminGroupService
{
    ...
    Task<AdminGroupResponse?> UpdateGroupAsync(Guid groupId, UpdateAdminGroupRequest request,
    ...
    Task<AdminHouseholdResponse?> CreateHouseholdAsync(CreateAdminHouseholdRequest request,
        CancellationToken ct = default);

    Task<AdminHouseholdResponse?> UpdateHouseholdAsync(Guid householdId, UpdateAdminHouseholdRequest request,
        CancellationToken ct = default);
